...
<body>
    ...
    <main>
        <div class="container">
            ...
            <div class="crud-user">
                <h3 class="crud-user_heading">Thêm sách</h1>
                    <!--CRUD -->
                            ...
                            <div class="crud-user_add-container">
                                <div class="crud-user_add">
                                    <div class="crud-user_add-name">
                                        <span class="crud-user_add-name lb_username lb_title">Tên Sách: <span class="highlight">*</span></span> <br>
                                    ...
                                    <div class="crud-user_add-value">
                                        ...
                                        <?php 
                                            $selectsql = "SELECT TenTG FROM tacgia";
                                        ...
                                        <?php 
                                            $selectsql = "SELECT TenTL FROM theloaisach";
                                            $result = mysqli_query($conn,$selectsql);
                                            while($row = mysqli_fetch_assoc($result)){
                                        ...
                                        <?php 
                                            $selectsql = "SELECT TenNXB FROM nhaxuatban";
                                            $result = mysqli_query($conn,$selectsql);
                                            while($row = mysqli_fetch_assoc($result)){
                                        ...
                                        <div class="nb_value-container">
                                            <input class="crud-user_add-value nb_value" type="number" name="amount" id=""><span class="lb_value">(quyển)</span>
                                        </div>
                                    </div>
                                    <div class="notifii">
