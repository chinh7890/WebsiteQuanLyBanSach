<div class="container-list-parent">
                        <ul class="container_list">
                            <?php
                                ...
                                $selectCgr = "SELECT * FROM danhmucsach";
                                    ...
                                    <ul class="container_list-sub">
                                        <li class="container_list-item-sub">
                                            <div class="container_nav-item-sub">
                                                <lable 
                                                    class="container_list-link-sub-title">Thể
                                                    loại</lable>';
                                                $selectCgr2 = "SELECT * FROM theloaisach WHERE MaDM = '".$rowCgr['MaDM']."'";
                                        ...
                                        <li class="container_list-item-sub">
                                            <div class="container_nav-item-sub">
                                                <label
                                                    class="container_list-link-sub-title">TÁC
                                                    GIẢ</label>';
                                                    $selectathr = "SELECT * FROM tacgia WHERE MaDM = '".$rowCgr['MaDM']."'";
                                                    $resultathr = mysqli_query($conn, $selectathr);
                                                    while($rowathr = mysqli_fetch_assoc($resultathr)){
                                                    echo'                                                   
                                                <a href="productList.php?aid='.$rowathr['MaTG'].'"
                                                    class="container_list-link-sub-hover container_list-link-sub">'.$rowathr['TenTG'].'</a>';}
                                                    echo'
                                            </div>
                                        </li>
                                        <li class="container_list-item-sub">
                                            <div class="container_nav-item-sub">
                                                ...
                                                <label
                                                    class="container_list-link-sub-title">NHÀ
                                                    XUẤT BẢN</label>';
                                                    $selectpls = "SELECT * FROM nhaxuatban WHERE MaDM = '".$rowCgr['MaDM']."'";
                                                    $resultpls = mysqli_query($conn, $selectpls);
                                                    while($rowpls = mysqli_fetch_assoc($resultpls)){
                                                    echo' 
                                                <a href="productList.php?pid='.$rowpls['MaNXB'].'"
                                                    class="container_list-link-sub-hover container_list-link-sub">'.$rowpls['TenNXB'].'</a>';}
                                                    echo'
                                            </div>
                                        </li>
                                    </ul>
