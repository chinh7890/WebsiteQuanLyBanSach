                            ...
                            <form action="" method="post">
                                <table>
                                    ...
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM sach WHERE MaSach IN ('$cartstr')";
                                    ...
                                    <tr>
                                        ...
                                        <td class="cart-name-number">                                            
                                            <p class="cart-name"><?php echo $row['TenSach'] ?></p><br>
                                            ...
                                            ?>" required>
                                            <label class="cart-countbook" for="">Còn lại: <span class="cart-countbook-span"><?php echo $row['SoluongTon'] ?></span> quyển</label>
                                        </td>
                                        <td class="cart-price-delete">
                                            <p class="cart-price"><?php echo number_format($row['Gia']) ?>đ</p><br>
                                            <a class="cart-delete" href="cart.php?id=<?php echo $row['MaSach']?>&&action=delete">Xoá</a>
                                        </td>
                                    </tr>
                                    ...
                                    if(isset($_SESSION['amount']) && isset($_SESSION['cart'])){
                                            ...
                                            array_push($_SESSION['id-product'], $row['MaSach']);
                                            $total += $_SESSION['amount'][$index]*$row['Gia'];}                  
                                        if(empty($_SESSION['detail'])){
                                            $_SESSION['detail'] = $_SESSION['detail'].$row['TenSach']." (".$_SESSION['amount'][$index]." quyển)";
                                        }
                                        else{
                                            $_SESSION['detail'] = $_SESSION['detail'].", ".$row['TenSach']." (".$_SESSION['amount'][$index]." quyển)";
                                        }
                        ...
                        <div>
                            ...
                            <div class="form-info">
                                <form class="form-info-form" action="add2cart.php?action=order&&total=<?php echo $total ?>" method="post">
                                    ...
                                    <input class="form-input" type="text" name="name" id="" required><br>
                                    <label class="form-label" for="">Email:<span class="highlight">*</span></label>
                                    <input class="form-input" type="email" name="email" id="" required><br>
                                    <label class="form-label" for="">Số điện thoại:<span class="highlight">*</span></label>
                                    <input class="form-input" type="number" name="numberphone" id="" required><br>
                                    <label class="form-label" for="">Địa chỉ:<span class="highlight">*</span></label>
                                    <input class="form-input" type="text" name="address" id="" required>
                                    <div class="order">
