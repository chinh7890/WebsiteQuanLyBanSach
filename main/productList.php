                    ...
                    <div class="container_list-product">
                            ...
                            <div class="list-product_sort">
                                ...
                                <div class="sort_select--con">
                                    <ul class="sort_select" title="Sắp xếp theo">
                                        ...
                                        <a href=""><li><button name="az<?php echo $name ?>" value="<?php echo $value ?>" class="sort_li">Tên: A - Z</button></li></a>
                                        <a href=""><li><button name="za<?php echo $name ?>" value="<?php echo $value ?>" class="sort_li">Tên: Z - A</button></li></a>
                                        <a href=""><li><button name="lh<?php echo $name ?>" value="<?php echo $value ?>" class="sort_li">Giá: thấp đến cao</button></li></a>
                                        <a href=""><li><button name="hl<?php echo $name ?>" value="<?php echo $value ?>" class="sort_li">Giá: cao đến thấp</button></li></a>
                                    </ul>
                                </div>
                            </div>
                        </form>
                        <div class="list-product_table">
                                ...
                                if(isset($_GET['aid'])){    
                                    ...
                                    INNER JOIN theloaisach ON sach.MaTL = theloaisach.MaTL
                                    INNER JOIN nhaxuatban ON sach.MaNXB = nhaxuatban.MaNXB
                                    WHERE sach.MaTG = '$id' && sach.SoluongTon > 0 LIMIT 20";
                                    $resultPdt = mysqli_query($conn,$selectPdt);
                                    if(mysqli_num_rows($resultPdt)){
                                        while($rowPdt = mysqli_fetch_assoc($resultPdt)){
                                            $title = $rowPdt['TenSach'];
                                ...
                                if(isset($_GET['pid'])){
                                    ...
                                    INNER JOIN theloaisach ON sach.MaTL = theloaisach.MaTL
                                    INNER JOIN nhaxuatban ON sach.MaNXB = nhaxuatban.MaNXB
                                    WHERE sach.MaNXB = '$id' && sach.SoluongTon > 0 LIMIT 20";
                                    $resultPdt = mysqli_query($conn,$selectPdt);
                                    if(mysqli_num_rows($resultPdt)){
                                        while($rowPdt = mysqli_fetch_assoc($resultPdt)){
                                            $title = $rowPdt['TenSach'];
                                ...
                                if(isset($_GET['sid'])){
                                    ...
                                    $char = $_SESSION['char'];
                                    $selectPdt = "SELECT sach.MaSach, sach.TenSach, sach.MoTa, sach.AnhMinhHoa, tacgia.TenTG, theloaisach.TenTL, nhaxuatban.TenNXB, sach.Gia, sach.GiamGia, sach.SoluongTon 
                                    FROM sach 
                                    INNER JOIN tacgia ON sach.MaTG = tacgia.MaTG 
                                    INNER JOIN theloaisach ON sach.MaTL = theloaisach.MaTL 
                                    INNER JOIN nhaxuatban ON sach.MaNXB = nhaxuatban.MaNXB 
                                    WHERE (sach.TenSach LIKE '%$char%' OR theloaisach.TenTL LIKE '%$char%' OR tacgia.TenTG LIKE '%$char%' OR nhaxuatban.TenNXB LIKE '%$char%') 
                                    and sach.SoluongTon > 0 LIMIT 20";
                                    $resultPdt = mysqli_query($conn,$selectPdt);
                                    if(mysqli_num_rows($resultPdt)){
                                        while($rowPdt = mysqli_fetch_assoc($resultPdt)){
                                            $title = $rowPdt['TenSach'];
                                ...
                                if(isset($_GET['azcid']) || isset($_GET['zacid']) || isset($_GET['hlcid']) || isset($_GET['lhcid'])){
                                    ...
                                    INNER JOIN theloaisach ON sach.MaTL = theloaisach.MaTL
                                    INNER JOIN nhaxuatban ON sach.MaNXB = nhaxuatban.MaNXB
                                    WHERE sach.MaTL = '$id' && sach.SoluongTon > 0 ORDER BY $column $condition LIMIT 20";
                                    $resultPdt = mysqli_query($conn,$selectPdt);
                                    if(mysqli_num_rows($resultPdt)){
                                        while($rowPdt = mysqli_fetch_assoc($resultPdt)){
                                            $title = $rowPdt['TenSach'];
                                ...
                                if(isset($_GET['azaid']) || isset($_GET['zaaid']) || isset($_GET['hlaid']) || isset($_GET['lhaid'])){
                                    ...
                                    INNER JOIN theloaisach ON sach.MaTL = theloaisach.MaTL
                                    INNER JOIN nhaxuatban ON sach.MaNXB = nhaxuatban.MaNXB
                                    WHERE sach.MaTG = '$id' && sach.SoluongTon > 0 ORDER BY $column $condition LIMIT 20";
                                    $resultPdt = mysqli_query($conn,$selectPdt);
                                    if(mysqli_num_rows($resultPdt)){
                                        while($rowPdt = mysqli_fetch_assoc($resultPdt)){
                                            $title = $rowPdt['TenSach'];
                                ...
                                if(isset($_GET['azpid']) || isset($_GET['zapid']) || isset($_GET['hlpid']) || isset($_GET['lhpid'])){
                                    ...
                                    INNER JOIN theloaisach ON sach.MaTL = theloaisach.MaTL
                                    INNER JOIN nhaxuatban ON sach.MaNXB = nhaxuatban.MaNXB
                                    WHERE sach.MaNXB = '$id' && sach.SoluongTon > 0 ORDER BY $column $condition LIMIT 20";
                                    $resultPdt = mysqli_query($conn,$selectPdt);
                                    if(mysqli_num_rows($resultPdt)){
                                        while($rowPdt = mysqli_fetch_assoc($resultPdt)){
                                            $title = $rowPdt['TenSach'];
                                ...
                                if(isset($_GET['azsid']) || isset($_GET['zasid']) || isset($_GET['hlsid']) || isset($_GET['lhsid'])){
                                    ...
                                    INNER JOIN nhaxuatban ON sach.MaNXB = nhaxuatban.MaNXB
                                    WHERE (sach.TenSach LIKE '%$char%' OR theloaisach.TenTL LIKE '%$char%' OR tacgia.TenTG LIKE '%$char%' OR nhaxuatban.TenNXB LIKE '%$char%')
                                    and sach.SoluongTon > 0 ORDER BY $column $condition LIMIT 20";
                                    $resultPdt = mysqli_query($conn,$selectPdt);
                                    if(mysqli_num_rows($resultPdt)){
                                        while($rowPdt = mysqli_fetch_assoc($resultPdt)){
                                            $title = $rowPdt['TenSach'];
